...
class _HomeService implements HomeService {
  ...
  Future<GetProductsResponse> getProducts({
    required GetProductsRequestBody body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<GetProductsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'products',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetProductsResponse _value;
    try {
      _value = GetProductsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<GetCartItemsResponse> getCartItems() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetCartItemsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'cart',
  ...
  Future<DecrementCartItemResponse> decrementCartItem({
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<DecrementCartItemResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DecrementCartItemResponse _value;
    try {
      _value = DecrementCartItemResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<ApplyCouponResponse> applyCoupon({
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<ApplyCouponResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'cart/apply-coupon',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApplyCouponResponse _value;
    try {
      _value = ApplyCouponResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<UpdateCartItemResponse> updateCartItem({
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<UpdateCartItemResponse>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'cart/items/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdateCartItemResponse _value;
    try {
      _value = UpdateCartItemResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<GetReviewsResponse> getReviews({
    required GetReviewsRequestBody body,
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<GetReviewsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'reviews/${productId}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetReviewsResponse _value;
    try {
      _value = GetReviewsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AddReviewResponse> addReview({
    required AddReviewRequestBody body,
    required String productId,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
