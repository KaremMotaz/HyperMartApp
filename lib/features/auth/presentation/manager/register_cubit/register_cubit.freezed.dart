...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  registerInitial,TResult Function()?  registerLoading,TResult Function( String email)?  registerSuccess,TResult Function( ApiErrorModel apiErrorModel)?  registerFailure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegisterInitial() when registerInitial != null:
...
return registerSuccess(_that.email);case RegisterFailure() when registerFailure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  registerInitial,required TResult Function()  registerLoading,required TResult Function( String email)  registerSuccess,required TResult Function( ApiErrorModel apiErrorModel)  registerFailure,}) {final _that = this;
switch (_that) {
case _RegisterInitial():
return registerInitial();case RegisterLoading():
return registerLoading();case RegisterSuccess():
return registerSuccess(_that.email);case RegisterFailure():
return registerFailure(_that.apiErrorModel);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  registerInitial,TResult? Function()?  registerLoading,TResult? Function( String email)?  registerSuccess,TResult? Function( ApiErrorModel apiErrorModel)?  registerFailure,}) {final _that = this;
switch (_that) {
case _RegisterInitial() when registerInitial != null:
return registerInitial();case RegisterLoading() when registerLoading != null:
return registerLoading();case RegisterSuccess() when registerSuccess != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RegisterSuccess&&(identical(other.email, email) || other.email == email));
}
...
@override
String toString() {
  return 'RegisterState.registerSuccess(email: $email)';
}
